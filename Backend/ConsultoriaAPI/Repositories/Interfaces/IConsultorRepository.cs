...
public interface IConsultorRepository
{
    ...
    Task<int> ActualizarAsync(int id, string nombreCompleto, string emailCorporativo, string areaEspecializacion, decimal tarifaHora, int cantidadProyectosActivos, bool activo, CancellationToken cancellationToken = default);
